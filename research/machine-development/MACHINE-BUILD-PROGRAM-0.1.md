...
**Status:** current Program machine-development research program  
**Owner:** `GeorgePlattDemo/3d-solutions-program`  
**Source lineage:** relocated from `scan-to-build-system@eb6c6e9f021f8b3bb102288276bb85a9dad82b09`, `work/machines/MACHINE-BUILD-PROGRAM-0.1.md`.  
**Purpose:** define the physical bridge experiment without pretending the middle is already known  
**Primary patent sources:** `GeorgePlattDemo/scan-to-build-system/docs/patents/`  
...
Every Machine Build document must use `GeorgePlattDemo/scan-to-build-system/docs/patents/PATENT-ALIGNMENT-GATE.md` and state:
