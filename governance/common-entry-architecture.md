...
**Status:** Program architecture rule.  
**Owner:** 3D Solutions Program.  
**Source lineage:** Governed Reference `18949f163718a937f072f4be3a654bb303e53160`, `docs/architecture/common-entry-contexts.md` (STB-ENTRY-0.3.0), reconciled against current System ownership.  
**Does not:** define System routes, create application enums, activate schemas, change Store authority, or authorize physical work.
